    ...
    <DialogPortal container={container}>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "max-sm:left-1/2 max-sm:top-auto max-sm:bottom-[max(0.75rem,var(--safe-area-bottom,0px),var(--eliza-chat-clearance,0px))] max-sm:max-h-[min(calc(100dvh_-_1rem_-_var(--safe-area-top,0px)_-_max(var(--safe-area-bottom,0px),var(--eliza-chat-clearance,0px))),42rem)] max-sm:w-[min(calc(100vw_-_1rem),42rem)] max-sm:translate-y-0 max-sm:rounded-sm max-sm:data-[state=closed]:slide-out-to-bottom-6 max-sm:data-[state=open]:slide-in-from-bottom-6",
